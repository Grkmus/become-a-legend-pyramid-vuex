def includeme(config):
    ...
    config.add_route('get_login_form', '/login')
    config.add_route('logout', '/logout')

    config.add_route('get_all_players', '/player/all')
    ...
    config.add_route('get_player', '/player/{id}')
    ...
    config.add_route('get_all_events', '/event/all')
